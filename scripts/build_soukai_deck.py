...
# =========================================================
# SLIDE 3 — HOW BIG：AI市場の“規模”（マクロ3数字）
# =========================================================
s = slide()
header(s, "2", "AI投資は、桁が違う。国家予算級のマネーが動いている。", "AI市場の盛り上がりは、どれくらいの規模か")

macro = [
    ("約110兆円", "Big Tech 4社のAI投資（2026年・年間）",
     "MS・Google・Amazon・Metaの設備投資合計 約7,250億ドル。前年比 +77%。ほぼ全額がAIインフラ。"),
    ("13倍", "国内DC・半導体の最大電力（10年で）",
     "DC/半導体工場の新増設に伴う最大需要電力は 56万kW→715万kW（'25→'34年度・OCCTO見通し）。"),
...
text(s, 1.15, 5.9, 11.0, 0.9,
     [[R("この“物理”を作るのは、", 15, INK, True),
       R("日本の製造業", 15, RED, True), R("。", 15, INK, True),
       R("世界のAIマネーが、国内の受注として現場に降ってくる。", 15, INK, True)]],
     anchor=MSO_ANCHOR.MIDDLE)

# =========================================================
# SLIDE 4 — WHERE：その金が“どこ”に着地するか（バリューチェーン×企業数字）
# =========================================================
s = slide()
header(s, "3", "世界のAIマネーは、日本の製造業のこの現場に着地している。", "AI需要は、バリューチェーンのどこに効くのか")
...
# =========================================================
s = slide()
header(s, "4", "建設で磨いた“現場管理”を、そのまま製造業のフィールドへ。", "我々は、どの業界に・どんな価値を提供するのか")
...
text(s, 0.85, 0.9, 0.62, 0.62, [[R("5", 18, WHITE, True, FONT_M)]],
     align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
